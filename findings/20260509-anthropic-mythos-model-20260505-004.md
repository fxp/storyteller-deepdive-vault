...
**来源**: [Anthropic just dropped benchmark scores for their unreleased model. The gap is embarrassing for everyone else. : r/ClaudeCode](https://www.reddit.com/r/ClaudeCode/comments/1sf4yvm/anthropic_just_dropped_benchmark_scores_for_their/)
**发现时间**: 2026-05-09
**所属事件**: [[anthropic-mythos-model-20260505]]

## 摘要

Anthropic发布了其未发布模型的基准分数，引发了业界的关注。
